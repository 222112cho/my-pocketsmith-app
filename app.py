...
PERSONALITY_PROFILES = {
    "脉冲体验者": {
        "desc": "极易被新鲜感与情绪驱动，为即时快乐买单，资金留存率偏低。"[cite: 1],
        "advice_rule": "⚠️ 拦截建议：启动 72 小时冷静期！3天后依然想买再决定，通常可拦截 80% 冲动支出。"[cite: 1]
    },
    "沉浸品质家": {
        "desc": "追求质感与深度体验，不在意数量，单笔开销大，现金流易阶段性波动。"[cite: 1],
        "advice_rule": "💎 诊断提示：请评估预估使用次数并计算“单次使用成本”（CP值），评估是否符合品质基金配额。"[cite: 1]
    },
    "策略精算师": {
        "desc": "极致比价，精通规则与凑单，享受优惠带来的掌控感，需防范凑单陷阱。"[cite: 1],
        "advice_rule": "🧮 诊断提示：核查是否存在为了凑满减而购买非刚需商品的情况，注意计算付出研究的时间成本。"[cite: 1]
    },
    "安稳守恒者": {
        "desc": "风险偏好极低，奉行非必要不支出，储蓄安全感极强，资金抗通胀率较低。"[cite: 1],
        "advice_rule": "🛡️ 诊断提示：开销极为克制。刚需消费建议一步到位购买高质量耐用品，降低长期维护损耗。"[cite: 1]
    },
    "社交随浪者": {
        "desc": "消费易受社交圈、人情及外界评价影响，被动与社交性支出偏高。"[cite: 1],
        "advice_rule": "👥 诊断提示：请关注“人际社交预算上限”，月末复盘评估该笔社交的实际投资回报率（ROI）。"[cite: 1]
    },
    "宏观规划家": {
        "desc": "极度理性自律，每笔开销都服务于长远财务目标与既定预算。"[cite: 1],
...
QUESTIONS_DB = [
    {
        "id": "Q1",
        "title": "连续加班一周后的周末，你最倾向于用哪种方式放松？"[cite: 1],
        "options": {
            "A": "狠狠点一顿大餐或买下购物车里搁置很久的衣服"[cite: 1],
            "B": "去预约很久的高档SPA、看演出或来一场高品质微度假"[cite: 1],
            "C": "找找附近有没有划算的小吃团购或免费的公园展览"[cite: 1],
            "D": "宅在家里做饭、追剧、打扫卫生，几乎零支出"[cite: 1]
        },
        "weights": {"A": {"E":2, "I":2}, "B": {"Q":2, "S":1}, "C": {"V":2, "R":1}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q2",
        "title": "在电商大促（如双11、618）期间，你的典型状态是？"[cite: 1],
        "options": {
            "A": "看到直播间“最后10秒”就忍不住跟着下单"[cite: 1],
            "B": "只买早已看好的大牌耐用品或提升生活质量的大件"[cite: 1],
            "C": "提前拉Excel表格计算跨店满减、消费券，务必拿到最低价"[cite: 1],
            "D": "基本不关注，手头的东西没坏就不买"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":2}, "B": {"Q":2, "R":1}, "C": {"V":2, "P":2}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q3",
        "title": "朋友突然约你吃一家人均消费超出你平时预算的网红餐厅，你会？"[cite: 1],
        "options": {
            "A": "毫不犹豫答应，大家开心最重要，大不了下周省省"[cite: 1],
            "B": "欣然前往，如果环境和菜品确实好，觉得很值得"[cite: 1],
            "C": "去之前先去各大平台搜一搜有没有优惠券或代金券"[cite: 1],
            "D": "找理由婉拒，或者建议换一家性价比更高的地方"[cite: 1]
        },
        "weights": {"A": {"S":2, "I":2}, "B": {"Q":2, "S":1}, "C": {"V":2, "R":1}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q4",
        "title": "购买一件高频使用的电子产品（如手机、电脑）时，你的决策核心是？"[cite: 1],
        "options": {
            "A": "外观好看、功能炫酷，有新出的颜色就想买"[cite: 1],
            "B": "顶级配置、极佳的使用体验与售后服务，多花点钱也值"[cite: 1],
            "C": "挑选很久，必须找到官方补贴、叠加满减后的最低价才下单"[cite: 1],
            "D": "性能满足未来3-5年使用即可，绝不超出手头既有预算"[cite: 1]
        },
        "weights": {"A": {"E":2, "I":1}, "B": {"Q":2, "R":1}, "C": {"V":2, "R":1}, "D": {"P":2, "F":2}}[cite: 1]
    },
    {
        "id": "Q5",
        "title": "逛街或刷软件时看到一件不在计划内但很喜欢的物件，你会？"[cite: 1],
        "options": {
            "A": "瞬间被击中，“不买今天就难受”，直接刷卡"[cite: 1],
            "B": "评估它的材质与设计，如果是高品质且能升华居家质感就拿下"[cite: 1],
            "C": "拿出手机搜同款，看看有没有更便宜的渠道或二手平台"[cite: 1],
            "D": "告诉自己“家里已经有了类似的/不是刚需”，冷静离开"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":2}, "B": {"Q":2, "R":1}, "C": {"V":2, "R":1}, "D": {"P":2, "F":2}}[cite: 1]
    },
    {
        "id": "Q6",
        "title": "你对各类会员订阅（如视频VIP、健身卡、音乐软件）的态度是？"[cite: 1],
        "options": {
            "A": "看到想看的剧就开一个月，不知不觉扣了许多自动续费"[cite: 1],
            "B": "只买高频使用的顶级体验服务（如无广告、高画质、私人教练）"[cite: 1],
            "C": "总是等拼单、联合赠送或新用户首月1元优惠时再开"[cite: 1],
            "D": "能用免费版的绝不付费，极少开通任何长期订阅"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":1}, "B": {"Q":2, "R":1}, "C": {"V":2, "R":1}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q7",
        "title": "查看上个月的账单时，你的第一反应通常是？"[cite: 1],
        "options": {
            "A": "“天呐，我怎么不知不觉花了这么多？钱都去哪了？”"[cite: 1],
            "B": "“虽然花了不少，但买到了好东西/体验了棒的项目，值了。”"[cite: 1],
            "C": "“虽然支出项多，但算下来靠优惠省下了好几百，很有成就感。”"[cite: 1],
            "D": "“基本都在预算控制内，剩余资金可以顺利存入理财账户。”"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":2}, "B": {"Q":2, "S":1}, "C": {"V":2, "R":1}, "D": {"P":2, "F":2}}[cite: 1]
    },
    {
        "id": "Q8",
        "title": "关于日常储蓄与理财，你目前的真实习惯是？"[cite: 1],
        "options": {
            "A": "随缘攒钱，发了工资先花，月末有剩余才存"[cite: 1],
            "B": "攒钱是为了下一次大的品质消费（如旅行、换大件）"[cite: 1],
            "C": "喜欢研究各种稳健理财、高息存款，精打细算让钱生钱"[cite: 1],
            "D": "严格执行强制储蓄，每月工资一到账就先划走预定比例"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":1}, "B": {"Q":2, "S":1}, "C": {"V":2, "R":2}, "D": {"P":2, "F":2}}[cite: 1]
    },
    {
        "id": "Q9",
        "title": "如果你突然获得了一笔计划外的小奖金（如2000元），你会？"[cite: 1],
        "options": {
            "A": "奖励自己一场说走就走的旅行或心仪很久的奢品"[cite: 1],
            "B": "升级家里的某样生活用品，提升日常生活品质"[cite: 1],
            "C": "存起来大半，剩下小部分用来找优惠购买刚需品"[cite: 1],
            "D": "100%直接转入储蓄或投资账户，不增加任何额外消费"[cite: 1]
        },
        "weights": {"A": {"E":2, "I":2}, "B": {"Q":2, "R":1}, "C": {"V":2, "F":1}, "D": {"F":2, "P":2}}[cite: 1]
    },
    {
        "id": "Q10",
        "title": "面对“买二送一”或“满300减50”这类促销活动，你常做的是？"[cite: 1],
        "options": {
            "A": "为了凑满减，不知不觉买了一堆原本没打算买的东西"[cite: 1],
            "B": "只有凑单的东西本身符合品质要求时才会顺便凑"[cite: 1],
            "C": "精确计算每一件商品的折后单价，甚至找陌生人拼单"[cite: 1],
            "D": "保持警惕，坚决不为了凑数而购买不需要的物品"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":2}, "B": {"Q":2, "R":1}, "C": {"V":2, "R":1}, "D": {"P":2, "F":2}}[cite: 1]
    },
    {
        "id": "Q11",
        "title": "在处理旧物（如二手衣服、旧家电）时，你一般会？"[cite: 1],
        "options": {
            "A": "堆在家里占地方，或者懒得处理直接扔掉"[cite: 1],
            "B": "能送人就送人，或者回收给环保机构"[cite: 1],
            "C": "细心拍照、撰写文案，挂在二手平台卖掉变现"[cite: 1],
            "D": "尽量用到坏为止，极少产生不必要的淘汰旧物"[cite: 1]
        },
        "weights": {"A": {"I":1, "E":1}, "B": {"S":1, "Q":1}, "C": {"V":2, "R":1}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q12",
        "title": "临近月末发现预算有点紧张时，你会怎么应对？"[cite: 1],
        "options": {
            "A": "稍微收敛一点，但遇到喜欢的依然会用花呗/信用卡支付"[cite: 1],
            "B": "减少不必要的社交活动，但基本的日常饮食品质不下降"[cite: 1],
            "C": "开启“极致省钱模式”，顿顿找外卖红包或自己做饭"[cite: 1],
            "D": "几乎不会遇到这种情况，因为每月的开销都在严格掌控中"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":2}, "B": {"Q":2, "S":1}, "C": {"V":2, "F":1}, "D": {"P":2, "F":2}}[cite: 1]
    },
    {
        "id": "Q13",
        "title": "对于网红打卡地、流行单品或爆款美食，你的态度是？"[cite: 1],
        "options": {
            "A": "很感兴趣，愿意排队或付费去尝鲜体验"[cite: 1],
            "B": "只有当它确实具备独特的高品质或文化价值时才会去"[cite: 1],
            "C": "等热度过了、有优惠券或者打折时再去体验"[cite: 1],
            "D": "完全不感冒，对跟风消费天然免疫"[cite: 1]
        },
        "weights": {"A": {"E":2, "S":1}, "B": {"Q":2, "R":1}, "C": {"V":2, "R":1}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q14",
        "title": "你平时对微小支出（如打车代步、外卖配送费、饮料）的感知是？"[cite: 1],
        "options": {
            "A": "觉得都是小钱，平时不太在意，累积起来才发现很吓人"[cite: 1],
            "B": "只要能节省时间或带来舒适感，花点小钱很值得"[cite: 1],
            "C": "极度看重，会尽量用免费骑行券、找免配送费店家"[cite: 1],
            "D": "习惯步行/公交，自带水壶，能避免的小开销尽量避免"[cite: 1]
        },
        "weights": {"A": {"I":2, "E":2}, "B": {"Q":2, "S":1}, "C": {"V":2, "R":1}, "D": {"F":2, "P":1}}[cite: 1]
    },
    {
        "id": "Q15",
        "title": "你希望这套消费管理系统未来最能帮你解决什么问题？"[cite: 1],
        "options": {
            "A": "斩断冲动消费，帮我守住钱包"[cite: 1],
            "B": "在不降低生活品质的前提下，优化非必要开支"[cite: 1],
            "C": "帮我自动比价和整理优惠，把精打细算做到极致"[cite: 1],
            "D": "提供清晰的财务分析图表，辅助我实现长期资产规划"[cite: 1]
        },
        "weights": {"A": {"E":2, "I":2}, "B": {"Q":2, "R":1}, "C": {"V":2, "R":1}, "D": {"P":2, "F":2}}[cite: 1]
    }
]
...
if st.session_state.in_quiz_mode:
    ...
    <style>
        ...
        .stRadio label { font-size: 1.1rem !important; color: #f8fafc !important; }
    </style>
    """, unsafe_allow_html=True)
    
    st.title("🧬 消费基因深度评估沉浸式体验")
    st.caption("基于 8 维特征计分法 (E, R, Q, V, I, P, S, F) 构建，答题完成后系统将自动重新校准您的管家诊断逻辑。"[cite: 1])
    ...
    if curr_step <= total_q:
        ...
        st.markdown(f"""
        <div class="quiz-card">
            <h3 style="color: #38bdf8; margin-top:0;">{q_data['id']}. {q_data['title']}</h3>
        </div>
        """, unsafe_allow_html=True)
        ...
        # 6大人格指数公式
        scores = {
            "脉冲体验者": dim_scores["E"] * 1.2 + dim_scores["I"] * 1.2,[cite: 1]
            "沉浸品质家": dim_scores["Q"] * 1.5 + dim_scores["R"] * 0.5,[cite: 1]
            "策略精算师": dim_scores["V"] * 1.5 + dim_scores["R"] * 0.5,[cite: 1]
            "安稳守恒者": dim_scores["F"] * 1.2 + dim_scores["P"] * 1.0,[cite: 1]
            "社交随浪者": dim_scores["S"] * 1.5 + dim_scores["E"] * 0.8,[cite: 1]
            "宏观规划家": dim_scores["P"] * 1.2 + dim_scores["F"] * 0.8 + dim_scores["R"] * 0.5[cite: 1]
        }
        ...
        has_secondary = (primary_score - secondary_score) / (primary_score + 1e-5) < 0.15[cite: 1]
